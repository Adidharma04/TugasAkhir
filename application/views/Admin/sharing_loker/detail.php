        ...
        <div class="col-12 col-lg-7 d-flex align-items-stretch" >
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span>  <b>Nama Pekerjaan : </b> <?= $job_vacancy->nama_pekerjaan?></li>
                        <br>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-envelope"></i></span>   <b>Deskripsi Pekerjaan : </b> <?= $job_vacancy->deskripsi_pekerjaan?></li>
                        <br>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span>  <b>Alamat : </b> <?= $job_vacancy->alamat?></li>
                        <br>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-venus"></i></span>     <b>Status : </b> <?= $job_vacancy->status?></li>
                      </ul>
                    </div>
                    <div class="col-5 text-center">
                      <img src=" <?= base_url('assets/Gambar/Upload/Loker/') . $job_vacancy->foto ?>" alt="user-avatar" class="img-circle img-fluid" style= "width:300px; height:200px;">
                    </div>
                  </div>
                </div>
