                        ...
                        <td>
                          <div class="row">
                            ...
                            <div class="col-md-9">
                              ...
                              <label style="font-size: 13px"><i class="far fa-calendar-alt"></i> <?php echo $ifu->created_at ?> <span class="badge badge-success"><?php echo $ifu->status ?></span> </label>  
                            </div>
                          </div>
                        </td>
                        <td>
                    ...
                    ?>
                      <div class="col-md-9">
                          <div class="text-center">
                            ...
                            <h4 style="margin: 5px">Tambahkan Informasi Umum</h4>
