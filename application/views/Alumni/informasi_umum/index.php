            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                      <a href="Informasi_umum/tambah" class="btn btn-tool">
                ...
                <div class="card-body">
                  ...
                  if ( $informasi_umum->num_rows() == 1 ) {

                    $baris = $informasi_umum->result();
          
                    $nama_informasi = $baris->nama_informasi;
                    $deskripsi_informasi = $baris->deskripsi_informasi;
                    $status = $baris->status;
                    $foto = $baris->foto;
                  ...
                  <table class="table" width="100%">
                    ...
                    <tr>
                      <td>
                        <div class="row">
                        <?php if ( $informasi_umum->num_rows() == 1 ) { ?>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-9">
                            <label for="" style="font-size: 18px;"><?php echo ucfirst($nama_informasi) ?></label> <br>
                            <small>"<?php echo $deskripsi_informasi ?>"</small> <br><hr style="margin: 5px">
                            <label style="font-size: 13px"><i class="far fa-calendar-alt"></i>  <span class="badge badge-success"><?php echo $status ?></span> </label>  
                          </div>
                          <?php } else {  ?>
                            <div class="col-md-9">
                              ...
                              <h4 style="margin: 5px">Tambahkan Informasi </h4>
                              <small>Masukkan Informasi yang akan datang......</small> <br><br>
                              <a href="<?= base_url("Alumni/informasi_umum/tambah")?>" class="btn <?php echo $btnColor ?>"><?php echo $btnText ?></a>
                          </div>
                          </div>
