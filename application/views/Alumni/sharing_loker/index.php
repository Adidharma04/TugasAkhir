      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <p>Deskripsi penjelasan Sharing loker</p>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                      <a href="sharing_loker/tambah" class="btn btn-tool">
                ...
                <div class="card-body">
                  <?php
                  // button
                    $btnText = "Tambah Loker";
                    $btnColor = "btn-primary";
                  if ( $job_vacancy->num_rows() == 1 ) {

                    $baris = $job_vacancy->result();
          
                    $nama_pekerjaan = $baris->nama_pekerjaan;
                    $deskripsi_pekerjaan = $baris->deskripsi_pekerjaan;
                    $alamat = $baris->alamat;
                    $status = $baris->status;
                    $foto = $baris->foto;
                    ...
                    <tr>
                      <td>
                        ...
                        <?php if ( $job_vacancy->num_rows() == 1 ) { ?>
                          ...
                          <div class="col-md-9">
                            <label for="" style="font-size: 18px;"><?php echo ucfirst($nama_pekerjaan) ?></label> <br>
                            <small>"<?php echo $deskripsi_pekerjaan ?>"</small> <br><hr style="margin: 5px">
                            <label style="font-size: 13px"><i class="fa fa-building"></i> <?php echo $alamat ?>  &emsp; | &emsp; <i class="far fa-calendar-alt"></i>  <span class="badge badge-success"><?php echo $status ?></span> </label>  
                          </div>
                          <?php } else {  ?>
                            <div class="col-md-9">
                              ...
                              <h4 style="margin: 5px">Tambahkan Sharing Loker </h4>
                              <small>Masukkan Sharing Loker yang akan datang......</small> <br><br>
                              <a href="<?= base_url("Alumni/sharing_loker/tambah")?>" class="btn <?php echo $btnColor ?>"><?php echo $btnText ?></a>
                          </div>
                          </div>
