                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="teachers-thumbnail">
                            <img src="<?php echo base_url().'assets/Gambar/Website/Dashboard/masnafis.jpg';?>" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                            <h5>Ibnu Nafis, S.T</h5>
                            <span>Surveyor</span><br>
                            <span>PT. Biro Klasifikasi Indonesia</span><br>
                            <span>Persero</span><br>
                            <span>Jl. Yos Sudarso 38-40,Tanjung Priok,Jakarta</span><br>
                            <span>Tahun Masuk : 2011</span><br>
                            <span>Tahun Keluar :-</span><br>
                        </div>
                    </div>
                </div>
                <!-- Single Teachers -->
