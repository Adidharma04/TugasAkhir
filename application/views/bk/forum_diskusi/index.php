                ...
                <div class="row">
                            ...
                            <div class="modal fade" id="tambah-topik">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo base_url('bk/forum_diskusi/prosestambah') ?>" method="POST">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="<?php echo base_url('bk/Forum_diskusi/tambahForum/') ?>">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active">
                                        ...
                                        foreach ($nilaiyangmuncul as $row) { ?>
                                            <a href="<?php echo base_url('bk/forum_diskusi/discuss/' . $row['id_forum']) ?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            if ( $level == "staff" || $level == "bk" ) {
                                                                ...
                                                                echo '
                                                                    <div class="text-sm">
                                                                    <a href="'.base_url('bk/forum_diskusi/editForum/').$row['id_forum'].'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"> </i>Sunting</a> &nbsp;
                                                                    ...
                                                                    <div class="modal fade" id="action-hapus-'.$row['id_forum'].'">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                            <label>
                                                                                Apakah anda yakin ingin menghapus forum diskusi ini?
                                                                            </label> <br>
                                                                            <small>Forum yang telah dihapus tidak dapat dipulihkan.</small>
                                                                            </div>
                                                                            <div class="modal-footer justify-content-between">
